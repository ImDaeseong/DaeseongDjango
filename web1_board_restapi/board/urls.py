...
urlpatterns = [
    ...
    path('getlist1/', List_API_1.as_view()),  # rest framework API 1
    path('getlist2/', List_API_2.as_view()),  # rest framework API 2
    path('getlist3/', views.List_API_3),  # rest framework API 3
    path('getlist4/', views.List_API_4),  # rest framework API 4
]
