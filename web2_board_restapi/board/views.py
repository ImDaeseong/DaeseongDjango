...
from board.serializers import boardSerializerAll, boardSerializer


# rest framework API 1
class List_API_ViewSet1(ModelViewSet):
    queryset = board_content.objects.all()
    serializer_class = boardSerializerAll


# rest framework API 2
class List_API_ViewSet2(ModelViewSet):
    queryset = board_content.objects.all()
